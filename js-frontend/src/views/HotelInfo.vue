...
<input type="date" class="border rounded col-auto" name="startdate" placeholder="Check in"/>
    <label class="col-12" for="enddate">Check out</label>
            <input type="date" class="border rounded col-auto" name="enddate" placeholder="Check out"/>
