...
module.exports = function () {
    ...
    this.Given(/^that i am on the Holidaymaker site$/, async function () {
      ...
      this.Given(/^and press search$/, async function () {
      ...
      this.Then(/^i should have a booking$/, async function () {
        ...
        await driver.wait(until.elementLocated(By.css("#app > div > div.container.border.rounded.py-3.text-left.bg-light > div.container.border.rounded.py-3.text-left.allBookings > div:nth-child(1) > div")))
        ...
        assert.include(startDateText, "Check In: 2020-05-24")
        let endDate = await $('#app > div > div.container.border.rounded.py-3.text-left.bg-light > div.container.border.rounded.py-3.text-left.allBookings > div:nth-child(1) > div > div.col-9 > p:nth-child(6)')
        let endDateText = endDate.getText()
        assert.include(endDateText, "Check Out: 2020-05-25")
